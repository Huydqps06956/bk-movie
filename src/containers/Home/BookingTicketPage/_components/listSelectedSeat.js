  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div>
          <p className="ml-3">
            <span className="upper-text text-warning" style={{ fontWeight: "bold" }}>Tên phim : </span>
            <span className="upper-text">{this.props.thongTinPhim?.tenPhim}</span>
          </p>
          <p className="ml-3">
            <span className="upper-text text-warning" style={{ fontWeight: "bold" }}>Ngày chiếu : </span>
            <span>{this.props.thongTinPhim?.ngayChieu}</span>
          </p>
          <p className="ml-3">
            <span className="upper-text text-warning" style={{ fontWeight: "bold" }}>Giờ chiếu : </span>
        ...
        <div className="table-wrapper-scroll-y my-custom-scrollbar">
          <table id="main-table" className="table table-dark table-sm">
            ...
            <tfoot>
              <tr className="text-danger upper-text">
                <td>Tổng tiền</td>
                <td>
